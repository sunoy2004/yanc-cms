...
A modern, production-ready headless CMS built with NestJS, Prisma, and Supabase Storage integration.
...
Supabase PostgreSQL (metadata only)
        ↓
Supabase Storage (media storage only)
```
...
- **Supabase Media Storage**: Secure file handling with Supabase Storage
...
│       │   │   ├── auth/     # Authentication
│       │   │   ├── media/    # Media management (Supabase Storage)
...
2. **Supabase Storage Upload Failed**
