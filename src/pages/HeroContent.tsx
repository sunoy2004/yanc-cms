...
const mockHeroItems: HeroContent[] = [
  {
    ...
    description: 'Connect with like-minded individuals and accelerate your growth journey',
    ctaText: 'Get Started',
    ctaLink: '/apply',
    mediaItems: [],
    isActive: true,
  ...
  },
  {
    ...
    description: 'Learn from experienced professionals and build meaningful relationships',
  ...
  },
  {
    ...
    description: 'Join our programs and turn your vision into impactful solutions',
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Enter hero description/tagline"
                  rows={3}
                />
              </div>
