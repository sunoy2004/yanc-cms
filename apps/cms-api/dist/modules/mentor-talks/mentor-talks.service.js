...
var MentorTalksService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MentorTalksService = void 0;
const common_1 = require("@nestjs/common");
const supabase_service_1 = require("../../supabase/supabase.service");
let MentorTalksService = MentorTalksService_1 = class MentorTalksService {
    constructor(supabase) {
        this.supabase = supabase;
        this.logger = new common_1.Logger(MentorTalksService_1.name);
    }
    async getMentorTalks() {
        ...
        `)
            ...
            const processedTalks = await Promise.all(data.map(async (talk) => {
    ...
    async updateMentorTalk(id, dto) {
        try {
            ...
            if (dto.speakerBio !== undefined)
                updateData.speaker_bio = dto.speakerBio;
            if (dto.talkDate !== undefined)
                updateData.date = dto.talkDate;
    ...
    async updateTalkGallery(supabaseClient, talkId, mediaIds) {
        try {
            ...
            if (galleryItems.length === 0) {
                this.logger.warn(`⚠️ Skipping gallery update for talk ${talkId} because no valid mediaIds were resolved. Existing gallery is preserved.`);
                return;
            }
            await supabaseClient
                .from('mentor_talk_gallery_items')
...
exports.MentorTalksService = MentorTalksService;
exports.MentorTalksService = MentorTalksService = MentorTalksService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [supabase_service_1.SupabaseService])
], MentorTalksService);
//# sourceMappingURL=mentor-talks.service.js.map